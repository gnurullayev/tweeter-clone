            ...
            <ul className='sidebar__list'>
                <li className="sidebar__item">
                    ...
                    style={{fontWeight: pathname === "/" ? "700" : "600"}}>
                        <svg viewBox="0 0 24 24" aria-hidden="true" class= {`sidebar__link-img ${pathname === "/" ? "active": ""}`}><g><path d="M22.58 7.35L12.475 1.897c-.297-.16-.654-.16-.95 0L1.425 7.35c-.486.264-.667.87-.405 1.356.18.335.525.525.88.525.16 0 .324-.038.475-.12l.734-.396 1.59 11.25c.216 1.214 1.31 2.062 2.66 2.062h9.282c1.35 0 2.444-.848 2.662-2.088l1.588-11.225.737.398c.485.263 1.092.082 1.354-.404.263-.486.08-1.093-.404-1.355zM12 15.435c-1.795 0-3.25-1.455-3.25-3.25s1.455-3.25 3.25-3.25 3.25 1.455 3.25 3.25-1.455 3.25-3.25 3.25z"></path></g></svg>
                        <span>Home</span>
                    </Link>
                </li>
                ...
                <li className="sidebar__item">
                    ...
                    style={{fontWeight: pathname === "/message" ? "700" : "600"}}>
                        <svg viewBox="0 0 24 24" aria-hidden="true" class={`sidebar__link-img ${pathname === "/message" ? "active": ""}`}><g><path d="M19.25 3.018H4.75C3.233 3.018 2 4.252 2 5.77v12.495c0 1.518 1.233 2.753 2.75 2.753h14.5c1.517 0 2.75-1.235 2.75-2.753V5.77c0-1.518-1.233-2.752-2.75-2.752zm-14.5 1.5h14.5c.69 0 1.25.56 1.25 1.25v.714l-8.05 5.367c-.273.18-.626.182-.9-.002L3.5 6.482v-.714c0-.69.56-1.25 1.25-1.25zm14.5 14.998H4.75c-.69 0-1.25-.56-1.25-1.25V8.24l7.24 4.83c.383.256.822.384 1.26.384.44 0 .877-.128 1.26-.383l7.24-4.83v10.022c0 .69-.56 1.25-1.25 1.25z"></path></g></svg>
                        <span>Messages</span>
                    </Link>
                </li>
                ...
                <li className="sidebar__item">
                    ...
                    style={{fontWeight: pathname === "/bookmark" ? "700" : "600"}}>
                       <svg viewBox="0 0 24 24" aria-hidden="true" class={`sidebar__link-img ${pathname === "/bookmark" ? "active": ""}`}><g><path d="M19.9 23.5c-.2 0-.3 0-.4-.1L12 17.9l-7.5 5.4c-.2.2-.5.2-.8.1-.2-.1-.4-.4-.4-.7V5.6c0-1.2 1-2.2 2.2-2.2h12.8c1.2 0 2.2 1 2.2 2.2v17.1c0 .3-.2.5-.4.7 0 .1-.1.1-.2.1z"></path></g></svg>
                        <span>Bookmarks</span>
                    </Link>
                </li>
                <li className="sidebar__item">
                    ...
                    style={{fontWeight: pathname === "/lists" ? "700" : "600"}}>
                        <svg viewBox="0 0 24 24" aria-hidden="true" class={`sidebar__link-img ${pathname === "/lists" ? "active": ""}`}><g><path d="M19.75 22H4.25C3.01 22 2 20.99 2 19.75V4.25C2 3.01 3.01 2 4.25 2h15.5C20.99 2 22 3.01 22 4.25v15.5c0 1.24-1.01 2.25-2.25 2.25zM4.25 3.5c-.414 0-.75.337-.75.75v15.5c0 .413.336.75.75.75h15.5c.414 0 .75-.337.75-.75V4.25c0-.413-.336-.75-.75-.75H4.25z"></path><path d="M17 8.64H7c-.414 0-.75-.337-.75-.75s.336-.75.75-.75h10c.414 0 .75.335.75.75s-.336.75-.75.75zm0 4.11H7c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h10c.414 0 .75.336.75.75s-.336.75-.75.75zm-5 4.11H7c-.414 0-.75-.335-.75-.75s.336-.75.75-.75h5c.414 0 .75.337.75.75s-.336.75-.75.75z"></path></g></svg>
                        <span>Lists</span>
                    </Link>
                </li>
